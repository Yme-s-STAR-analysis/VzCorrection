...
int main(int argc, char** argv){
    ...
    int x1 = atoi(x1s);
    int x2 = atoi(x2s);
    TFile* tf = new TFile("vz_ref3_corr.root");
    ...
    gPad->SetLogz();
    th->Draw("colz");
    c->Print(Form("vz_dist_corr_Ref%s_%s.pdf(", ref3Tag, trg));
    c->Print(Form("vz_dist_corr_Ref%s_%s_heatmap.png", ref3Tag, trg));
    ...
    for (int ipage=0; ipage<2; ipage++){ 
        ...
        c->Print(Form("vz_dist_corr_Ref%s_%s.pdf", ref3Tag, trg));
        c->Print(Form("vz_dist_corr_Ref%s_%s_p%d.png", ref3Tag, trg, ipage+1));
    }
    ...
    c->Print(Form("vz_dist_corr_Ref%s_%s.pdf)", ref3Tag, trg));
    c->Print(Form("vz_dist_corr_Ref%s_%s_p5.png", ref3Tag, trg));
    ...
    TFile* tsave = new TFile(Form("high_end_point_vz_Ref%s_%s_corr.root", ref3Tag, trg), "recreate");
    tsave->cd();
    tg->Write();
    hfunc->Write();
    tsave->Close();
